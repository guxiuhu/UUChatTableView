...
- (void)relayoutFrameOfSubViews
{
    ...
    [_tip alignParentBottomWithMargin:8];
}
...
- (BOOL)initRecord
{
    ...
    NSString *strUrl = [NSString stringWithFormat:@"%@/%@.mp4", [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject], @"12121212"];
